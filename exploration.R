...
# calculating the percentage of p-values for chi-square that are higher than 0.05 for each condition
satisfactory_chisq <- aggregate(ifelse(results$pvalue > 0.05, 1, 0), 
                                ...
                                FUN = mean)
names(satisfactory_chisq) <- c("Noninvariance Ratios", "Intercept Value", "Sample Group Size", "Satisfactory % Chi-square")
...
names(satisfactory_rmsea) <- c("Noninvariance Ratios", "Intercept Value", "Sample Group Size", "Satisfactory % RMSEA")
...
names(satisfactory_cfi) <- c("Noninvariance Ratios", "Intercept Value", "Sample Group Size", "Satisfactory % CFI")
